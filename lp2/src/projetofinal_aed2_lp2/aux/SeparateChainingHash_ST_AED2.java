 ...
 *  @author Kevin Wayne
 */
public class SeparateChainingHash_ST_AED2<Key, Value> implements Serializable{
     ...
     */
    public SeparateChainingHash_ST_AED2() {
        this(INIT_CAPACITY);
    } 
     ...
     */
    public SeparateChainingHash_ST_AED2(int m) {
        this.m = m;
    ...
    private void resize(int chains) {
        SeparateChainingHash_ST_AED2<Key, Value> temp = new SeparateChainingHash_ST_AED2<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
    ...
    public String toString() {
        String str = "Tabela de Hash(separateChaining) M="+ m + ", N= "+n;
        for(int i=0;i<m;i++){
            str = str +"\n"+i+":";
            for (Key k: st[i].keys())// dá erro com str em vez de st
                str =str +k+"->";
            str=str+"NULL";
        }return str;
    }
    ...
    public static void main(String[] args) { 
        SeparateChainingHash_ST_AED2<String, Integer> st = new SeparateChainingHash_ST_AED2<String, Integer>();
